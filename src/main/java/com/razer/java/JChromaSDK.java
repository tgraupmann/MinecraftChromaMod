...
public class JChromaSDK {
    ...
    */
    ...
    public void setKeysColorAllFramesName(String path, Pointer rzkeys, int keyCount, int color)
    {
    ...
    */
    ...
    public void setKeysColorAllFramesRGBName(String path, Pointer rzkeys, int keyCount, int red, int green, int blue)
    {
