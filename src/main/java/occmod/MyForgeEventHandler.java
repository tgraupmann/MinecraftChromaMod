...
public class MyForgeEventHandler {
	...
	public void handleLivingDeathEvent(LivingDeathEvent event) {
		...
		if (event.getEntityLiving().getClass() == EntityBat.class) {
			System.out.println("Bat died");
		} else if (event.getEntityLiving().getClass() == EntityZombie.class) {
			System.out.println("Zombie died");
		} else if (event.getEntityLiving().getClass() == EntityPig.class) {
			System.out.println("Pig died");
		} else {
			System.out
					.println("Something living died: " + entityLiving.getName() + " class " + entityLiving.getClass());
		}
	}
