 ...
 */
public class CustomMousepadEffect extends MousepadEffect implements ChromaEffect1D {
    public static final int MAX_LEDS = 15;
     ...
     */
    public CustomMousepadEffect(ColorRef[] colors) {
        super();
